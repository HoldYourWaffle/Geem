...
/**
 * Creates {@link BitmapFont} instances from FreeType font files. Requires a
 * {@link FreeTypeFontLoaderParameter} to be passed to
 * {@link AssetManager#load(String, Class, AssetLoaderParameters)} which
 * specifies the name of the TTF file as well the parameters used to generate
 * the BitmapFont (size, characters, etc.)
 */
public class FreetypeFontLoader
	...
	public Array<AssetDescriptor> getDependencies(String fileName, FileHandle file,
		...
		deps.add(new AssetDescriptor<>(parameter.fontFileName + ".gen",
