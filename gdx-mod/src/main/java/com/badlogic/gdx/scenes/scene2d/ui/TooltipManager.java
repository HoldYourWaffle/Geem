...
public class TooltipManager {
	...
	/**
	 * Once a tooltip is shown, this is used instead of {@link #initialTime}.
	 * Default is 0.
	 */
	...
	/**
	 * The maximum width of a {@link TextTooltip}. The label will wrap if needed.
	 * Default is Integer.MAX_VALUE.
	 */
	public float maxWidth = Integer.MAX_VALUE;
	/**
	 * The distance from the mouse position to offset the tooltip actor. Default is
	 * 15,19.
	 */
	public float offsetX = 15, offsetY = 19;
	/**
	 * The distance from the tooltip actor position to the edge of the screen where
	 ...
	 * A subclass must at least remove the actor.
	 */
