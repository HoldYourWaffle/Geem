 ...
 * {@link GL20#glScissor(int, int, int, int)}. When a new Rectangle is pushed
 * onto the stack, it will be merged with the current top of stack. The minimum
 * area of overlap is then set as the real top of the stack.
 * 
 * @author mzechner
 */
public class ScissorStack {
	 ...
	 * stack rectangle and the provided rectangle is pushed onto the stack. This
	 * will invoke {@link GL20#glScissor(int, int, int, int)} with the final top of
	 * stack rectangle. In case no scissor is yet on the stack this will also enable
	 * {@link GL20#GL_SCISSOR_TEST} automatically.
	 * <p>
	 * Any drawing should be flushed before pushing scissors.
	 * 
	 * @return true if the scissors were pushed. false if the scissor area was zero,
	 *         in this case the scissors were not pushed and no drawing should
	 *         occur.
	 */
	 ...
	 * stack, {@link GL20#GL_SCISSOR_TEST} is disabled.
	 * <p>
	 ...
	 * 
	 * @see #calculateScissors(Camera, float, float, float, float, Matrix4,
	 *      Rectangle, Rectangle)
	 */
	 ...
	 * only axis aligned rectangles will work with this method. If either the Camera
	 * or the Matrix4 have rotational components, the output of this method will not
	 * be suitable for {@link GL20#glScissor(int, int, int, int)}.
	 * 
	 * @param camera         the {@link Camera}
	 * @param batchTransform the transformation {@link Matrix4}
	 * @param area           the {@link Rectangle} to transform to window
	 *                       coordinates
