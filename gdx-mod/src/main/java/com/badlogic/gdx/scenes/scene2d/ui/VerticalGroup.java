 ...
 * wrapping. {@link #getChildren()} can be sorted to change the order of the
 * actors (eg {@link Actor#setZIndex(int)}). This can be easier than using
 * {@link Table} when actors need to be inserted into or removed from the middle
 * of the group. {@link #invalidate()} must be called after changing the
 * children order.
 * <p>
...
public class VerticalGroup extends WidgetGroup {
	 ...
	 * all widgets within the vertical group.
	 */
	 ...
	 * will be 0 as it is expected that something external will set the height of
	 * the group. Default is false.
	 * <p>
	 * When wrap is enabled, the group's preferred width depends on the height of
	 * the group. In some cases the parent of the group will need to layout twice:
	 * once to set the height of the group and a second time to adjust to the
	 * group's new preferred width.
	 */
	...
	/**
	 * Sets the alignment of widgets within each column of the vertical group. Set
	 * to {@link Align#center}, {@link Align#left}, or {@link Align#right}.
	 */
