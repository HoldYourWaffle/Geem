...
/**
 * EventListener for low-level input events. Unpacks {@link InputEvent}s and
 * calls the appropriate method. By default the methods here do nothing with the
 * event. Users are expected to override the methods they are interested in,
 * like this:
 * 
 * <pre>
...
public class InputListener implements EventListener {
	 ...
	 * even those not over this actor, until touchUp is received. Also when true is
	 * returned, the event is {@link Event#handle() handled}.
	 * 
	 * @see InputEvent
	 */
	public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
	 ...
	 * event is always {@link Event#handle() handled}.
	 * 
	 * @see InputEvent
	 */
	public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
	 ...
	 * touchDragged event is always {@link Event#handle() handled}.
	 * 
	 * @see InputEvent
	 */
