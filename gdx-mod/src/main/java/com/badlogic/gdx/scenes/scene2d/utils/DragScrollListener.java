 ...
 * touch focus using <code>stage.cancelTouchFocus(gloom.monstersScroll);</code>.
 * In this case the drag scroll listener must not be attached to the scroll
 * pane, else it would also lose touch focus. Instead it can be attached to the
 * scroll pane's actor.
 * <p>
