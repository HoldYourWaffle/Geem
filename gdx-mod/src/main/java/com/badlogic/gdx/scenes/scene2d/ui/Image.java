...
/**
 * Displays a {@link Drawable}, scaled various way within the widgets bounds.
 * The preferred size is the min size of the drawable. Only when using a
 * {@link TextureRegionDrawable} will the actor's scale, rotation, and origin be
 * used when drawing.
 * 
 * @author Nathan Sweet
 */
public class Image extends Widget {
	...
	/**
	 * Sets a new drawable for the image. The image's pref size is the drawable's
	 * min size. If using the image actor's size rather than the pref size,
	 * {@link #pack()} can be used to size the image to its pref size.
	 * 
	 * @param drawable May be null.
	 */
