...
public class Cell<T extends Actor> implements Poolable {
	...
	/**
	 * Sets the actor in this cell and adds the actor to the cell's table. If null,
	 * removes any current actor.
	 */
	...
	/**
	 * Sets the minWidth, prefWidth, maxWidth, minHeight, prefHeight, and maxHeight
	...
	/**
	 * Sets the spaceTop, spaceLeft, spaceBottom, and spaceRight to the specified
	 * value.
	 */
	 ...
	 * {@link Align#top}, {@link Align#bottom}, {@link Align#left},
	 * {@link Align#right}, or any combination of those.
	 */
	...
	/**
	 * Sets the alignment of the actor within the cell to {@link Align#center}. This
	...
	/**
	 * Reset state so the cell can be reused, setting all constraints to their
	 * {@link #defaults() default} values.
	 */
	@Override
	public void reset() {
		actor = null;
	...
	/**
	 * Returns the defaults to use for all cells. This can be used to avoid needing
	 * to set the same defaults for every table (eg, for spacing).
	 */
