 ...
 * buttons. This enables "radio button" functionality and more. A button may
 * only be in one group at a time.
 * <p>
 * The {@link #canCheck(Button, boolean)} method can be overridden to control if
 * a button check or uncheck is allowed.
 * 
 * @author Nathan Sweet
 */
public class ButtonGroup<T extends Button> {
	 ...
	 * maximum is not exceeded. If false, additional buttons beyond the maximum are
	 * not allowed to be checked. Default is true.
	 */
