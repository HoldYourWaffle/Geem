...
/**
 * {@link AssetLoader} for {@link I18NBundle} instances. The I18NBundle is
 * loaded asynchronously.
 * <p>
 * Notice that you can't load two bundles with the same base name and different
 * locale or encoding using the same {@link AssetManager}. For example, if you
 * try to load the 2 bundles below
 * 
 * <pre>
 ...
 * the same bundle since they have the same name. There are 2 use cases:
 * <ul>
 * <li>If you want to load the English bundle so to replace the Italian bundle
 * you have to unload the Italian bundle first.
 * <li>If you want to load the English bundle without replacing the Italian
 * bundle you should use another asset manager.
 * </ul>
 * 
 * @author davebaol
 */
