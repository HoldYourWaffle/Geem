...
/**
 * {@link AssetLoader} for {@link Cubemap} instances. The pixel data is loaded
 * asynchronously. The texture is then created on the rendering thread,
 * synchronously. Passing a {@link CubemapParameter} to
 * {@link AssetManager#load(String, Class, AssetLoaderParameters)} allows one to
 * specify parameters as can be passed to the various Cubemap constructors, e.g.
 * filtering and so on.
 * 
