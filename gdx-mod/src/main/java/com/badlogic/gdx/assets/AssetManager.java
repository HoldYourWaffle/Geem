...
public class AssetManager implements Disposable {
	 ...
	 * milliseconds, yielding the CPU to the loading thread between updates. This
	 * may block for less time if all loading tasks are complete. This may block for
	 * more time if the portion of a single task that happens in the GL thread takes
	 * a long time.
	 * 
	 * @return true if all loading is finished.
	 */
