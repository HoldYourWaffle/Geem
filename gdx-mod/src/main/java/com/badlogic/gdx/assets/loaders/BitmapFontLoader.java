 ...
 * description file (.fnt) asynchronously, loads the {@link Texture} containing
 * the glyphs as a dependency. The {@link BitmapFontParameter} allows you to set
 * things like texture filters or whether to flip the glyphs vertically.
 * 
 * @author mzechner
 */
