...
public class MapLayer {
	...
	/**
	 * @return the layer's x render offset, this takes into consideration all parent
	 *         layers' offsets
	 **/
	...
	/**
	 * @return the layer's y render offset, this takes into consideration all parent
	 *         layers' offsets
	 **/
	...
	/**
	 * set the renderOffsetDirty state to true, when this layer or any parents'
	 * offset has changed
	 **/
	...
	/**
	 * @return the layer's parent {@link MapLayer}, or null if the layer does not
	 *         have a parent
	 **/
