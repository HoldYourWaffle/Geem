...
public class AnimatedTiledMapTile implements TiledMapTile {
	...
	/**
	 * Function is called by BatchTiledMapRenderer render(), lastTiledMapRenderTime
	 * is used to keep all of the tiles in lock-step animation and avoids having to
	 * call TimeUtils.millis() in getTextureRegion()
	 */
	 ...
	 * @param frameTiles An array of {@link StaticTiledMapTile}s that make up the
	 *                   animation.
	 */
	 ...
	 *
	 * @param intervals  The intervals between each individual frame tile in
	 *                   milliseconds.
	 * @param frameTiles An array of {@link StaticTiledMapTile}s that make up the
	 *                   animation.
	 */
