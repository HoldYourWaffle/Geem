...
/**
 * @brief Set of string indexed values representing map elements' properties,
 *        allowing to retrieve, modify and add properties to the set.
 */
public class MapProperties {
	 ...
	 * @throws ClassCastException if the object with the given key is not of type
	 *                            clazz
	 */
