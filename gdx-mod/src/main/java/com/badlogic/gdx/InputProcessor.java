 ...
 * the {@link Input#setInputProcessor(InputProcessor)} method. It will be called
 * each frame before the call to {@link ApplicationListener#render()}. Each
 * method returns a boolean in case you want to use this with the
...
public interface InputProcessor {
	 ...
	 * 
	 * @param amount the scroll amount, -1 or 1 depending on the direction the wheel
	 *               was scrolled.
	 * @return whether the input was processed.
	 */
