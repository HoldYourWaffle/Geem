...
public class Attributes implements Iterable<Attribute>, Comparator<Attribute>, Comparable<Attributes> {
	 ...
	 *         types are specified, true if this collection has all specified
	 *         attributes, i.e. attributes.has(out, ColorAttribute.Diffuse |
	 *         ColorAttribute.Specular | TextureAttribute.Diffuse);
	 */
	 ...
	 * 
	 * @param compareValues True to compare attribute values, false to only compare
	 *                      attribute types
	 * @return True if this collection contains the same attributes (and optionally
	 *         attribute values) as the other.
	 */
	 ...
	 * 
	 * @return True if this collection contains the same attributes (but not values)
	 *         as the other.
	 */
	 ...
	 *         include other properties as well, i.e. the material id.
	 */
