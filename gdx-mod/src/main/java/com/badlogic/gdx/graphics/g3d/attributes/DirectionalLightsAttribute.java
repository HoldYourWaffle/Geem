 ...
 * {@link DirectionalLight} instances to the {@link Shader}. The lights are
 * stored by reference, the {@link #copy()} or
 * {@link #DirectionalLightsAttribute(DirectionalLightsAttribute)} method will
 * not create new lights.
 * 
 * @author Xoppa
 */
