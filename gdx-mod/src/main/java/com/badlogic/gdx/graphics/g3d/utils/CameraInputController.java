...
public class CameraInputController extends GestureDetector {
	...
	/**
	 * The units to translate the camera when moved the full width or height of the
	 * screen.
	 */
	...
	/**
	 * The key which must be pressed to activate rotate, translate and forward or 0
	 * to always activate.
	 */
