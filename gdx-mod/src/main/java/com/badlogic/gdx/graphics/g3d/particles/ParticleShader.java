...
/**
 * This is a custom shader to render the particles. Usually is not required,
 * because the {@link DefaultShader} will be used instead. This shader will be
 * used when dealing with billboards using GPU mode or point sprites.
 * 
 * @author inferno
 */
public class ParticleShader extends BaseShader {
	...
	public static String getDefaultVertexShader() {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.classpath("com/badlogic/gdx/graphics/g3d/particles/particles.vertex.glsl")
					.readString();
	...
	public static class Setters {
		...
		public final static Setter cameraInvDirection = new Setter() {
			...
			@Override
			public void set(BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
				shader.set(inputID, TMP_VECTOR3
						.set(-shader.camera.direction.x, -shader.camera.direction.y, -shader.camera.direction.z).nor());
			}
		};
