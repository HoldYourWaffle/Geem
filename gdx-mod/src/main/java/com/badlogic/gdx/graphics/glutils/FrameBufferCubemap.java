 ...
 * cubemap for the color attachment and a renderbuffer for the depth buffer. You
 * can get a hold of the cubemap by
 * {@link FrameBufferCubemap#getColorBufferTexture()}. This class will only work
 * with OpenGL ES 2.0.
 * </p>
 *
 * <p>
 ...
 * <p>
 * Typical use: <br />
 * FrameBufferCubemap frameBuffer = new FrameBufferCubemap(Format.RGBA8888,
 * fSize, fSize, true); <br />
...
public class FrameBufferCubemap extends GLFrameBuffer<Cubemap> {
	 ...
	 *
	 * @param format     the format of the color buffer; according to the OpenGL ES
	 *                   2.0 spec, only RGB565, RGBA4444 and RGB5_A1 are
	 *                   color-renderable
	 ...
	 * @throws com.badlogic.gdx.utils.GdxRuntimeException in case the FrameBuffer
	 ...
	 * {@link #bindSide(com.badlogic.gdx.graphics.Cubemap.CubemapSide)} to activate
	 * the side to render onto.
	 */
	@Override
	public void bind() {
		currentSide = -1;
