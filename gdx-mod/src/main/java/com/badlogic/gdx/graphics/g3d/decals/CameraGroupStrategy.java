...
/**
 * <p>
 * Minimalistic grouping strategy that splits decals into opaque and transparent
 * ones enabling and disabling blending as needed. Opaque decals are rendered
 * first (decal color is ignored in opacity check).<br/>
 * Use this strategy only if the vast majority of your decals are opaque and the
 * few transparent ones are unlikely to overlap.
 * </p>
 * <p>
 * Can produce invisible artifacts when transparent decals overlap each other.
 * </p>
 * <p>
 * Needs to be explicitly disposed as it might allocate a ShaderProgram when
 * GLSL 2.0 is used.
 * </p>
 * <p>
