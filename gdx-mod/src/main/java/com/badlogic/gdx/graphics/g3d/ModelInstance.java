...
/**
 * An instance of a {@link Model}, allows to specify global transform and modify
 * the materials, as it has a copy of the model's materials. Multiple instances
 * can be created from the same Model, all sharing the meshes and textures of
 * the Model. The Model owns the meshes and textures, to dispose of these, the
 * Model has to be disposed. Therefor, the Model must outlive all its
 * ModelInstances
 * </p>
 * 
...
public class ModelInstance implements RenderableProvider {
	/**
	 * Whether, by default, {@link NodeKeyframe}'s are shared amongst {@link Model}
	 * and ModelInstance. Can be overridden per ModelInstance using the constructor
	 * argument.
	 */
	 ...
	 *                       for the instance to contain
	 * @param mergeTransform True to apply the source node transform to the instance
	 *                       transform, resetting the node transform.
	 */
	 ...
	 *                       reference or null to create a new matrix.
	 * @param nodeId         The ID of the root {@link Node} of the {@link Model}
	 *                       for the instance to contain
	 * @param mergeTransform True to apply the source node transform to the instance
	 *                       transform, resetting the node transform.
	 ...
	 *                        for the instance to contain
	 * @param parentTransform True to apply the parent's node transform to the
	 *                        instance (only applicable if recursive is true).
	 * @param mergeTransform  True to apply the source node transform to the
	 *                        instance transform, resetting the node transform.
	 */
	 ...
	 * @param nodeId          The ID of the {@link Node} within the {@link Model}
	 *                        for the instance to contain
	 * @param recursive       True to recursively search the Model's node tree,
	 *                        false to only search for a root node
	 * @param parentTransform True to apply the parent's node transform to the
	 *                        instance (only applicable if recursive is true).
	 * @param mergeTransform  True to apply the source node transform to the
	 *                        instance transform, resetting the node transform.
