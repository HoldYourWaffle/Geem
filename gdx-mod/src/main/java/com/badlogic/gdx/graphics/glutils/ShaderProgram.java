 ...
 * 
 * <p>
 * After construction a ShaderProgram can be used to draw {@link Mesh}. To make
 * the GPU use a specific ShaderProgram the programs
 * {@link ShaderProgram#begin()} method must be used which effectively binds the
 * program.
 * </p>
 * 
 * <p>
...
public class ShaderProgram implements Disposable {
	...
	/**
	 * code that is always added to the vertex shader code, typically used to inject
	 * a #version line. Note that this is added as-is, you should include a newline
	 * (`\n`) if needed.
	 */
	public static String prependVertexCode = "";
	
	/**
	 * code that is always added to every fragment shader code, typically used to
	 * inject a #version line. Note that this is added as-is, you should include a
	 * newline (`\n`) if needed.
	 */
...
// }
	...
	/**
	 * Sets the uniform with the given name. The {@link ShaderProgram} must be bound
	 * for this to work.
	 * 
	...
	/**
	 * Sets the uniform matrix with the given name. The {@link ShaderProgram} must
	...
	/**
	 * Sets an array of uniform matrices with the given name. The
	 * {@link ShaderProgram} must be bound for this to work.
	 * 
	 * @param name      the name of the uniform
	...
	/**
	 * Sets the vertex attribute with the given name. The {@link ShaderProgram} must
	 * be bound for this to work.
	 * 
	 * @param name      the attribute name
	 * @param size      the number of components, must be >= 1 and <= 4
	 * @param type      the type, must be one of GL20.GL_BYTE,
	 *                  GL20.GL_UNSIGNED_BYTE, GL20.GL_SHORT,
	 *                  GL20.GL_UNSIGNED_SHORT,GL20.GL_FIXED, or GL20.GL_FLOAT.
	 *                  GL_FIXED will not work on the desktop
	 * @param normalize whether fixed point data should be normalized. Will not work
	 *                  on the desktop
	 ...
	 *                  on the desktop
	 * @param stride    the stride in bytes between successive attributes
	 * @param offset    byte offset into the vertex buffer object bound to
	...
	/**
	 * Makes OpenGL ES 2.0 use this vertex and fragment shader pair. When you are
	 * done with this shader you have to call {@link ShaderProgram#end()}.
	 */
	public void begin() {
		GL20 gl = Gdx.gl20;
		checkManaged();
	 ...
	 * mix it with dispose, that will release the shader resources.
	 */
	public void end() {
		GL20 gl = Gdx.gl20;
		gl.glUseProgram(0);
