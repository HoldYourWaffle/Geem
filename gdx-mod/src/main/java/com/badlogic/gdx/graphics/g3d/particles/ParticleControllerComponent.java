...
/**
 * It's the base class of every {@link ParticleController} component. A
 * component duty is to participate in one or some events during the simulation.
 * (i.e it can handle the particles emission or modify particle properties,
 * etc.).
 * 
 * @author inferno
 */
