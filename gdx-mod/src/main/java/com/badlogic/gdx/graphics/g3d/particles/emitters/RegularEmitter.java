...
/**
 * It's a generic use {@link Emitter} which fits most of the particles
...
public class RegularEmitter extends Emitter implements Json.Serializable {
	...
	/**
	 * Possible emission modes. Emission mode does not affect already emitted
	 * particles.
	 */
	...
	Enabled,
	/**
	 * Only valid for continuous emitters. It will only emit particles until the end
	 * of the effect duration. After that emission cycle will not be restarted.
	 */
