...
/**
 * An IndexData instance holds index data. Can be either a plain short buffer or
...
public interface IndexData extends Disposable {
	 ...
	 * count must equal the number of indices to be copied to this
	 * IndexBufferObject.
	 * </p>
	 * 
	 * <p>
	 ...
	 * {@link ShortBuffer#position()} of the specified buffer and copied the
	 * {@link ShortBuffer#remaining()} amount of indices. This can be called in
	 * between calls to {@link #bind()} and {@link #unbind()}. The index data will
	 ...
	 * wil be uploaded on the call to {@link #bind()}. If you need immediate
	 * uploading use {@link #setIndices(short[], int, int)}.
	 * </p>
	 * 
