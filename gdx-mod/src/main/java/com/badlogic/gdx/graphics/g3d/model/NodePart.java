 ...
 * {@link Node}'s graphical properties. A NodePart is the smallest visible part
...
public class NodePart {
	...
	/**
	 * Mapping to each bone (node) and the inverse transform of the bind pose. Will
	 * be used to fill the {@link #bones} array. May be null.
	 */
	 ...
	 * {@link ModelInstance#calculateTransforms()}. Do not set or change this value
	 * manually.
	 */
	public Matrix4[] bones;
	/**
	 * true by default. If set to false, this part will not participate in rendering
	 ...
	 * of the provided {@link Renderable} remain untouched. Note that the material,
	 * mesh and bones members are referenced, not copied. Any changes made to those
	 * objects will be reflected in both the NodePart and Renderable object.
	 * 
	 * @param out The Renderable of which to set the members to the values of this
	 *            NodePart.
	 */
