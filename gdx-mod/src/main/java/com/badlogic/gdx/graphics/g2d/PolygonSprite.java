...
public class PolygonSprite {
	 ...
	 * change the position or size of the sprite, you have to fetch the triangle
	 * again for it to be recomputed.
	 * 
	 ...
	 * {@link #setColor(float, float, float, float)} is subsequently called before
	 * drawing this sprite.
	 */
	 ...
	 * or {@link #setColor(float, float, float, float)} is subsequently called
