...
/**
 * A VertexData instance holds vertices for rendering with OpenGL. It is
 * implemented as either a {@link VertexArray} or a {@link VertexBufferObject}.
...
public interface VertexData extends Disposable {
	 ...
	 * the same as specified at construction time via {@link VertexAttributes}.
	 * <p>
	 ...
	 * uploading use {@link #setVertices(float[], int, int)}; Any modifications made
