...
/**
 * Encapsulate the formulas to spawn a particle on a mesh shape dealing with not
 * uniform area triangles.
 * 
 * @author Inferno
 */
public final class WeightMeshSpawnShapeValue extends MeshSpawnShapeValue {
	 ...
	 * mesh has not indices: the function will consider the vertices as a triangle
	 * strip.
	 */
