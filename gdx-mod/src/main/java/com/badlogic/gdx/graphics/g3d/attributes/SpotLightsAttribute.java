 ...
 * {@link SpotLight} instances to the {@link Shader}. The lights are stored by
 * reference, the {@link #copy()} or
 * {@link #SpotLightsAttribute(SpotLightsAttribute)} method will not create new
 * lights.
 * 
 * @author Xoppa
 */
