 ...
 * <p>
 * The data is bound via glVertexAttribPointer() according to the attribute
...
public class VertexBufferObject implements VertexData {
	...
	/**
	 * @return The GL enum used in the call to
	 *         {@link GL20#glBufferData(int, int, java.nio.Buffer, int)}, e.g.
	 ...
	 * {@link GL20#glBufferData(int, int, java.nio.Buffer, int)}, can only be called
	 * when the VBO is not bound.
	 */
