...
public abstract class Camera {
	 ...
	 * touch methods in {@link Input}. A z-coordinate of 0 will return a point on
	 * the near plane, a z-coordinate of 1 will return a point on the far plane.
	 * This method allows you to specify the viewport position and dimensions in the
	 * coordinate system expected by {@link GL20#glViewport(int, int, int, int)},
	 ...
	 * is assumed to span the whole screen and is fetched from
	 * {@link Graphics#getWidth()} and {@link Graphics#getHeight()}. The x- and
	 * y-coordinate of vec are assumed to be in screen coordinates (origin is the
	 * top left corner, y pointing down, x pointing to the right) as reported by the
	 * touch methods in {@link Input}. A z-coordinate of 0 will return a point on
	 * the near plane, a z-coordinate of 1 will return a point on the far plane.
	 ...
	 * screen coordinates origin is assumed to be in the top left corner, its y-axis
	 * pointing down, the x-axis pointing to the right. The returned instance is not
	 * a new instance but an internal member only accessible via this function.
	 * 
	 * @param viewportX      the coordinate of the bottom left corner of the
	 *                       viewport in glViewport coordinates.
	 * @param viewportY      the coordinate of the bottom left corner of the
