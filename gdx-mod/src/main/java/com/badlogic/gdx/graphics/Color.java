...
public class Color {
	...
	/**
	 * Linearly interpolates between this color and the target color by t which is
	 * in the range [0,1]. The result is stored in this color.
	 * 
	...
	/**
	 * Packs the color components into a 32-bit integer with the format ABGR and
	 * then converts it to a float. Note that no range checking is performed for
	 * higher performance.
	 * 
	...
	/**
	 * Packs the color components into a 32-bit integer with the format ABGR. Note
	 * that no range checking is performed for higher performance.
	 * 
	 * @param r the red component, 0 - 255
	 * @param g the green component, 0 - 255
	 * @param b the blue component, 0 - 255
	...
	/**
	 * Sets the Color components using the specified integer value in the format
	 * ARGB8888. This is the inverse to the argb8888(a, r, g, b) method
	 *
	 * @param color The Color to be modified.
	...
	/**
	 * Sets the Color components using the specified float value in the format
	 * ABGB8888.
	 * 
	 * @param color The Color to be modified.
	 */
	 ...
	 * convenient method for {@link #fromHsv(float, float, float)}. This is the
	 * inverse of {@link #toHsv(float[])}.
	 * 
	...
	/**
	 * Extract Hue-Saturation-Value. This is the inverse of
	 * {@link #fromHsv(float[])}.
	 * 
