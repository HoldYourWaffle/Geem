 ...
 * For example, the markup language defined by the {@code BitmapFontCache} class
...
public final class Colors {
	 ...
	 * @return the color to which the specified {@code name} is mapped, or
	 ...
	 * {@code Colors.getColors().put(name, color)}
	 * 
	 * @param name  the name of the color
	 * @param color the color
	 * @return the previous {@code color} associated with {@code name}, or
	 *         {@code null} if there was no mapping for {@code name} .
	 */
