 ...
 * {@link Graphics#newCursor(Pixmap, int, int)}. To set the cursor use
 * {@link Graphics#setCursor(Cursor)}. To use one of the system cursors, call
 * Graphics#setSystemCursor
 * </p>
 **/
