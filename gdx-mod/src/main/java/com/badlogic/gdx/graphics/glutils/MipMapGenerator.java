...
public class MipMapGenerator {
	...
	/**
	 * Sets the image data of the {@link Texture} based on the {@link Pixmap}. The
	 * texture must be bound for this to work. If <code>disposePixmap</code> is
	 * true, the pixmap will be disposed at the end of the method.
	 * 
