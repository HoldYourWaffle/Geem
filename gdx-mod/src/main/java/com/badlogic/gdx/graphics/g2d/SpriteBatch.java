...
public class SpriteBatch implements Batch {
	/**
	 * @deprecated Do not use, this field is for testing only and is likely to be
	 *             removed. Sets the {@link VertexDataType} to be used when gles 3
	 *             is not available, defaults to {@link VertexDataType#VertexArray}.
	 */
	@Deprecated
	...
	/**
	 * Constructs a new SpriteBatch with a size of 1000, one buffer, and the default
	 * shader.
	 * 
