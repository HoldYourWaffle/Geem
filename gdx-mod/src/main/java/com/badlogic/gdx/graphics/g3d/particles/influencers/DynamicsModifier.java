...
/**
 * It's the base class for any kind of influencer which operates on angular
 * velocity and acceleration of the particles. All the classes that will inherit
 * this base class can and should be used only as sub-influencer of an instance
 * of {@link DynamicsInfluencer} .
 * 
 * @author Inferno
 */
public abstract class DynamicsModifier extends Influencer {
	...
	public static class Rotational3D extends Angular {
		...
		public void update() {
			...
			// Multiply sum by constant quantity k = m*I_to(-1) , m could be optional while
