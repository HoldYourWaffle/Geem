...
/**
 * An {@link Emitter} is a {@link ParticleControllerComponent} which will handle
 * the particles emission. It must update the {@link Emitter#percent} to reflect
 * the current percentage of the current emission cycle. It should consider
 * {@link Emitter#minParticleCount} and {@link Emitter#maxParticleCount} to rule
 * particle emission. It should notify the particle controller when particles
 * are activated, killed, or when an emission cycle begins.
 * 
 * @author Inferno
 */
public abstract class Emitter extends ParticleControllerComponent implements Json.Serializable {
	...
	/**
	 * Current state of the emission, should be currentTime/ duration Must be
	 * updated on each update
	 */
