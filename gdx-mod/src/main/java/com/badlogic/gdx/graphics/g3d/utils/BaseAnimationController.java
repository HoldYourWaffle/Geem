...
/**
 * Base class for applying one or more {@link Animation}s to a
...
public class BaseAnimationController {
	 ...
	 * 
	 * @param target The {@link ModelInstance} on which the animations are being
	 *               performed.
	 */
	 ...
	 * {{@link #end()}.
	 * 
	 * @param weight The blend weight of this animation relative to the previous
	 *               applied animations.
	 */
