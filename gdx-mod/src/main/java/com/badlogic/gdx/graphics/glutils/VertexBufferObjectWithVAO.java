...
/**
 * <p>
 * A {@link VertexData} implementation that uses vertex buffer objects and
 * vertex array objects. (This is required for OpenGL 3.0+ core profiles. In
 * particular, the default VAO has been deprecated, as has the use of client
 * memory for passing vertex attributes.) Use of VAOs should give a slight
 * performance benefit since you don't have to bind the attributes on every draw
 * anymore.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * VertexBufferObjectWithVAO objects must be disposed via the {@link #dispose()}
 * method when no longer needed
 * </p>
 *
 * Code adapted from {@link VertexBufferObject}.
 * 
 * @author mzechner, Dave Clayton <contact@redskyforge.com>, Nate Austin
 *         <nate.austin gmail>
 */
