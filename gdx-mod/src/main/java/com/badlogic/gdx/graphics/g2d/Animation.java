 ...
 * for running or jumping. Each object in the Animation is called a key frame,
 * and multiple key frames make up the animation.
 * <p>
 * The animation's type is the class representing a frame of animation. For
 * example, a typical 2D animation could be made up of
 * {@link com.badlogic.gdx.graphics.g2d.TextureRegion TextureRegions} and would
 * be specified as:
 * <p>
...
public class Animation<T> {
	 ...
	 * @param keyFrames     the objects representing the frames. If this Array is
	 *                      type-aware, {@link #getKeyFrames()} can return the
	 *                      correct type of array. Otherwise, it returns an
	 *                      Object[].
	 */
	 ...
	 * Returns a frame based on the so called state time. This is the amount of
	 * seconds an object has spent in the state this Animation instance represents,
	 * e.g. running, jumping and so on using the mode specified by
	 ...
	 * stored.
	 * 
	 * @return The keyframes[] field. This array is an Object[] if the animation was
	 *         instantiated with an Array that was not type-aware.
	 */
