...
/**
 * The base class of all the {@link ParticleValue} values which spawn a particle
 * on a mesh shape.
 * 
 * @author Inferno
 */
public abstract class MeshSpawnShapeValue extends SpawnShapeValue {
	public static class Triangle {
		...
		public static Vector3 pick(float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3,
				float z3, Vector3 vector) {
	...
	protected Mesh mesh;
	/**
	 * the model this mesh belongs to. It can be null, but this means the mesh will
	 * not be able to be serialized correctly.
	 */
