...
/**
 * This contains all the definitions of particle related channels and channel
 * initializers. It is also used by the {@link ParticleController} to handle
 * temporary channels allocated by influencers.
 * 
 * @author inferno
 */
public class ParticleChannels {
	...
	public static final int VelocityStrengthStartOffset = 0, VelocityStrengthDiffOffset = 1,
			VelocityThetaStartOffset = 0, VelocityThetaDiffOffset = 1, VelocityPhiStartOffset = 2,
			VelocityPhiDiffOffset = 3;
