...
/**
 * A relatively lightweight class which can be used to render basic shapes which
 * don't need a node structure and alike. Can be used for batching both static
 * and dynamic shapes which share the same {@link Material} and transformation
 * {@link Matrix4} within the world. Use {@link ModelBatch} to render the
 * `ShapeCache`. Must be disposed when no longer needed to release native
 * resources.
 * <p>
 * How to use it :
 * </p>
