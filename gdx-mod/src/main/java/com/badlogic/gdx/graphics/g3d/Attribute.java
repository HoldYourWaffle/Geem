...
/**
 * Extend this class to implement a material attribute. Register the attribute
 * type by statically calling the {@link #register(String)} method, whose return
 * value should be used to instantiate the attribute. A class can implement
 * multiple types
 * 
 * @author Xoppa
 */
public abstract class Attribute implements Comparable<Attribute> {
	...
	/**
	 * Call this method to register a custom attribute type, see the wiki for an
	 * example. If the alias already exists, then that ID will be reused. The alias
	 * should be unambiguously and will by default be returned by the call to
	 * {@link #toString()}.
	 * 
	 * @param alias The alias of the type to register, must be different for each
	 *              dirrect type, will be used for debugging
	 * @return the ID of the newly registered type, or the ID of the existing type
	 *         if the alias was already registered
	 */
