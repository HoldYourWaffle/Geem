...
/**
 * A single vertex attribute defined by its {@link Usage}, its number of
 * components and its shader alias. The Usage is used for uniquely identifying
 * the vertex attribute from among its {@linkplain VertexAttributes} siblings.
 ...
 * is used by a {@link Mesh} when drawing with a {@link ShaderProgram}. The
 * alias can be changed at any time.
 * 
 * @author mzechner
 */
public final class VertexAttribute {
	...
	/**
	 * For fixed types, whether the values are normalized to either -1f and +1f
	 * (signed) or 0f and +1f (unsigned)
	 */
	public final boolean normalized;
	/**
	 * the OpenGL type of each component, e.g. {@link GL20#GL_FLOAT} or
	 * {@link GL20#GL_UNSIGNED_BYTE}
	 */
	 ...
	 * based on the usage.
	 * 
	 * @param usage         The attribute {@link Usage}, used to select the
	 *                      {@link #type} and for identification.
	 * @param numComponents the number of components of this attribute, must be
	 *                      between 1 and 4.
	 * @param alias         the alias used in a shader for this attribute. Can be
	 ...
	 * @param alias         the alias used in a shader for this attribute. Can be
	 *                      changed after construction.
	 * @param unit          Optional unit/index specifier, used for texture
	 ...
	 * @param numComponents the number of components of this attribute, must be
	 *                      between 1 and 4.
	 * @param type          the OpenGL type of each component, e.g.
	 *                      {@link GL20#GL_FLOAT} or {@link GL20#GL_UNSIGNED_BYTE}.
	 *                      Since {@link Mesh} stores vertex data in 32bit floats,
	 *                      the total size of this attribute (type size times number
	 *                      of components) must be a multiple of four.
	 * @param normalized    For fixed types, whether the values are normalized to
	 *                      either -1f and +1f (signed) or 0f and +1f (unsigned)
	 * @param alias         The alias used in a shader for this attribute. Can be
	 *                      changed after construction.
	 */
	 ...
	 *                      Since {@link Mesh} stores vertex data in 32bit floats,
	 *                      the total size of this attribute (type size times number
	 *                      of components) must be a multiple of four bytes.
	 * @param normalized    For fixed types, whether the values are normalized to
	 *                      either -1f and +1f (signed) or 0f and +1f (unsigned)
	 * @param alias         The alias used in a shader for this attribute. Can be
	 *                      changed after construction.
	 ...
	 *         typically done by the {@linkplain VertexAttributes} that owns the
	 *         VertexAttribute.
	 */
