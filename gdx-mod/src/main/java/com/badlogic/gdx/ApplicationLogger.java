...
/**
 * The ApplicationLogger provides an interface for a LibGDX Application to log
 * messages and exceptions. A default implementations is provided for each
 * backend, custom implementations can be provided and set using
