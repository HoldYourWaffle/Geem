...
public interface AudioDevice extends Disposable {
	...
	/**
	 * Writes the array of 16-bit signed PCM samples to the audio device and blocks
	...
	/**
	 * Frees all resources associated with this AudioDevice. Needs to be called when
