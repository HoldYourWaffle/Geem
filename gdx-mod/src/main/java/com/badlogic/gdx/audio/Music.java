 ...
 * pausing, resuming and so on. When you are done with using the Music instance
 * you have to dispose it via the {@link #dispose()} method.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * Music instances are automatically paused and resumed when an
 * {@link Application} is paused or resumed. See {@link ApplicationListener}.
 * </p>
 * 
 * <p>
 * <b>Note<b>: any values provided will not be clamped, it is the developer's
...
public interface Music extends Disposable {
	/**
	 * Starts the play back of the music stream. In case the stream was paused this
	 * will resume the play back. In case the music stream is finished playing this
