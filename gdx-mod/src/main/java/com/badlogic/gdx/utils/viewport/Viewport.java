...
/**
 * Manages a {@link Camera} and determines how world coordinates are mapped to
 * and from the screen.
 * 
...
public abstract class Viewport {
	 ...
	 * 
	 * @param centerCamera If true, the camera position is set to the center of the
	 *                     world.
	 */
	 ...
	 * calls {@link #apply(boolean)}. Typically called from
	 * {@link ApplicationListener#resize(int, int)} or
	 * {@link Screen#resize(int, int)}.
	 * <p>
	...
	/**
	 * Transforms a point to real screen coordinates (as opposed to OpenGL ES window
	 * coordinates), where the origin is in the top left and the the y-axis is
	 * pointing downwards.
	 */
	...
	/**
	 * The virtual width of this viewport in world coordinates. This width is scaled
	 * to the viewport's screen width.
	 */
	...
	/**
	 * Sets the viewport's height in screen coordinates. This is typically set by
	 * {@link #update(int, int, boolean)}.
	 */
	...
	/**
	 * Sets the viewport's position in screen coordinates. This is typically set by
	 * {@link #update(int, int, boolean)}.
	 */
	...
	/**
	 * Sets the viewport's bounds in screen coordinates. This is typically set by
	 * {@link #update(int, int, boolean)}.
	 */
