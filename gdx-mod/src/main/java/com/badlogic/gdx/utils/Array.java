...
public class Array<T> implements Iterable<T> {
	 ...
	 * is not Object, this field may only be accessed if the
	 ...
	 * array will have the same type of backing array and will be ordered if the
	 * specified array is ordered. The capacity is set to the number of elements, so
	 * any subsequent elements added will cause the backing array to be grown.
	 */
	 ...
	 * The new array will have the same type of backing array. The capacity is set
	...
	/**
	 * Creates a new array containing the elements in the specified array. The new
	 * array will have the same type of backing array. The capacity is set to the
	 * number of elements, so any subsequent elements added will cause the backing
	 * array to be grown.
	 * 
	 ...
	 * exists. Search is started from the end of an array.
	 * 
	 * @param value    May be null.
	 * @param identity If true, == comparison will be used. If false, .equals()
	 *                 comparison will be used.
	 ...
	 * method is not thread safe (uses {@link Sort#instance()}).
	 */
	public void sort() {
	 ...
	 * greater than 0, or a {@link com.badlogic.gdx.utils.GdxRuntimeException} will
	 * be thrown.
	 * 
	 * @see Select
	 * @param comparator used for comparison
	 * @param kthLowest  rank of desired object according to comparison, n is based
	 *                   on ordinal numbers, not array indices. for min value use 1,
	 *                   for max value use size of array, using 0 results in runtime
	 *                   exception.
	 ...
	 * Use the {@link ArrayIterator} constructor for nested or multithreaded
	 * iteration.
	 */
	@Override
	...
	/**
	 * Returns an iterable for the selected items in the array. Remove is supported,
	 * but not between hasNext() and next(). Note that the same iterable instance is
	 * returned each time this method is called. Use the
	 * {@link Predicate.PredicateIterable} constructor for nested or multithreaded
	 * iteration.
	 */
