...
public enum Scaling {
	/**
	 * Scales the source to fit the target while keeping the same aspect ratio. This
	 * may cause the source to be smaller than the target in one direction.
	 */
	fit,
	/**
	...
	fill,
	/**
	 * Scales the source to fill the target in the x direction while keeping the
	 * same aspect ratio. This may cause the source to be smaller or larger than the
	...
	fillY,
	/**
	 * Scales the source to fill the target. This may cause the source to not keep
	...
	/**
	 * Returns the size of the source scaled to the target. Note the same Vector2
	 * instance is always returned and should never be cached.
	 */
