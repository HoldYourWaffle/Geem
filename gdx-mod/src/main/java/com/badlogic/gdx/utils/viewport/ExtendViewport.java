...
/**
 * A viewport that keeps the world aspect ratio by extending the world in one
 * direction. The world is first scaled to fit within the viewport, then the
 * shorter dimension is lengthened to fill the viewport. A maximum size can be
 * specified to limit how much the world is extended and black bars
 * (letterboxing) are used for any remaining space.
 * 
 * @author Nathan Sweet
 */
