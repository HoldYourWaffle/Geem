 ...
 * 
 * This was modified to be used directly on streams, rather than via the command
 * line as in the LZMA SDK.
 * 
 * We only currently allow the default LZMA options to be used, as we know it
 * works on for our target usage.
 */
public class Lzma {
