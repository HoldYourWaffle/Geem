...
public class JsonWriter extends Writer {
	 ...
	 * using libgdx, which handles these types without truncation. Default is false.
	 */
	...
	static public enum OutputType {
		 ...
		 * Like JSON, but:
		 * <ul>
		 * <li>Names only require double quotes if they start with <code>space</code> or
		 * any of <code>":,}/</code> or they contain <code>//</code> or <code>/*</code>
		 * or <code>:</code>.
		 * <li>Values only require double quotes if they start with <code>space</code>
		 * or any of <code>":,{[]/</code> or they contain <code>//</code> or
		 * <code>/*</code> or any of <code>}],</code> or they are equal to
