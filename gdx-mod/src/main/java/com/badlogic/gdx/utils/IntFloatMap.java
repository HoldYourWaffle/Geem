...
/**
 * An unordered map where the keys are ints and values are floats. This
 * implementation is a cuckoo hash map using 3 hashes, random walking, and a
...
public class IntFloatMap implements Iterable<IntFloatMap.Entry> {
	...
	private void push(int insertKey, float insertValue, int index1, int key1, int index2, int key2, int index3,
			int key3) {
		int[] keyTable = this.keyTable;
