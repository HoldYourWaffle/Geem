...
public class Bits {
	 ...
	 * and only if it both initially had the value true and the corresponding bit in
	 ...
	 * <ul>
	 * <li>The bit initially has the value true, and the corresponding bit in the
	 * argument has the value false.</li>
	 * <li>The bit initially has the value false, and the corresponding bit in the
	 * argument has the value true.</li>
	 * </ul>
	 * 
	 * @param other
	 */
	 ...
	 * 
	 * @param other a bit set
	 * @return boolean indicating whether this bit set intersects the specified bit
	 *         set
	 */
