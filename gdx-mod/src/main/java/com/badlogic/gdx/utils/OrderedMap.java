...
/**
 * An {@link ObjectMap} that also stores keys in an {@link Array} using the
 * insertion order. There is some additional overhead for put and remove.
 * Iteration over the {@link #entries()}, {@link #keys()}, and {@link #values()}
 * is ordered and faster than an unordered map. Keys can also be accessed and
 * the order changed using {@link #orderedKeys()}.
 * 
 * @author Nathan Sweet
 */
public class OrderedMap<K, V> extends ObjectMap<K, V> {
	 ...
	 * Use the {@link OrderedMapEntries} constructor for nested or multithreaded
	 * iteration.
	 */
	@Override
	 ...
	 * the {@link OrderedMapValues} constructor for nested or multithreaded
	 * iteration.
	 */
	@Override
	 ...
	 * the same iterator instance is returned each time this method is called. Use
	 * the {@link OrderedMapKeys} constructor for nested or multithreaded iteration.
	 */
	@Override
	public Keys<K> keys() {
		if (keys1 == null) {
