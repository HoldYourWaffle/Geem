...
/**
 * An unordered map where the keys and values are ints. This implementation is a
 * cuckoo hash map using 3 hashes, random walking, and a small stash for
 * problematic keys. No allocation is done except when growing the table size.
 * <br>
 * <br>
