...
public class I18NBundle {
	 ...
	 * Notice that this method has no effect on the GWT backend where it's always
	 * assumed to be true.
	 */
	 ...
	 * method if no string for the given key can be found. If this flag is
	 ...
	 * can be found. If this flag is {@code false} the missing key surrounded by
	 * {@code ???} is returned.
	 */
	 ...
	 * @exception NullPointerException     if <code>baseFileHandle</code> is
	 *                                     <code>null</code>
	 * @exception MissingResourceException if no bundle for the specified base file
	 *                                     handle can be found
	 ...
	 * @exception NullPointerException     if <code>baseFileHandle</code> or
	 ...
	 * @param encoding       the charter encoding
	 * @return a bundle for the given base file handle and locale
	 * @exception NullPointerException     if <code>baseFileHandle</code>,
	 *                                     <code>locale</code> or
	 *                                     <code>encoding</code> is
	 *                                     <code>null</code>
	 * @exception MissingResourceException if no bundle for the specified base file
	 ...
	 * @exception MissingResourceException if no string for the given key can be
	 *                                     found and
	 *                                     {@link #getExceptionOnMissingKey()}
	 *                                     returns {@code true}
