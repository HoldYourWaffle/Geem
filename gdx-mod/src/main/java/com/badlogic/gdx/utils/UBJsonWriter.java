...
public class UBJsonWriter implements Closeable {
	 ...
	 * once at the array marker instead of repeating the type marker for each
	 * element.
	 * 
	 * @return this writer, for chaining
	 */
	 ...
	 * encoded once at the array marker instead of repeating the type marker for
	 * each element. element count are encoded once at the array marker instead of
	 * for each element.
	 * 
	 * @return this writer, for chaining
	 */
