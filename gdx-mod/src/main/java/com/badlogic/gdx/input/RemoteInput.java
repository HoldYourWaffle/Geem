...
/**
 * <p>
 * An {@link Input} implementation that receives touch, key, accelerometer and
 * compass events from a remote Android device. Just instantiate it and specify
 * the port it should listen on for incoming connections (default 8190). Then
 * store the new RemoteInput instance in Gdx.input. That's it.
 * </p>
 * 
 * <p>
 * On your Android device you can use the gdx-remote application available on
 * the Google Code page as an APK or in SVN (extensions/gdx-remote). Open it,
 * specify the IP address and the port of the PC your libgdx app is running on
 * and then tap away.
 * </p>
 * 
 * <p>
