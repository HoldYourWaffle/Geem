...
/**
 * A list of common request header constants of the HTTP protocol. See
...
public interface HttpRequestHeader {
	 ...
	 * is the standard port for the service requested.
	 * <p>
	 ...
	 * server it expects to receive additional fields in the trailer after the last,
	 * zero-sized, chunk.
	 * <p>
	 ...
	 * <p>
	 * Example: User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:12.0) Gecko/20100101
	 * Firefox/21.0
	 */
