...
public class SocketHints {
	 ...
	 * choose a protocol the values are simply compared, with larger values
	 * indicating stronger preferences. Negative values represent a lower priority
	 * than positive values. If the application prefers short connection time over
	 ...
	 * <p>
	 * The traffic class is bitset created by bitwise-or'ing values such the
	 * following :
	 * <ul>
	...
	/**
	 * Enable/disable SO_LINGER with the specified linger time in seconds. Only
	 * affects socket close.
	 */
	public boolean linger = false;
	/**
	 * The linger duration in seconds (NOT milliseconds!). Only used if linger is
	 * true!
	 */
