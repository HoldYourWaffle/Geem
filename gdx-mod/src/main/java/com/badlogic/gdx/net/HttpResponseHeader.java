...
/**
 * A list of common response header constants of the HTTP protocol. See
...
public interface HttpResponseHeader {
	...
	/**
	 * The date and time that the message was sent (in "HTTP-date" format as defined
	 * by RFC 7231).
	 * <p>
	 ...
	 * have never fully implemented it, a lot of websites set this field with fake
	 * policy text, that was enough to fool browsers the existence of P3P policy and
	 ...
	 * HTTP-date.
	 * <p>
	 * Example: Example 1: Retry-After: 120Example 2: Retry-After: Fri, 07 Nov 2014
	 * 23:59:59 GMT
	 */
