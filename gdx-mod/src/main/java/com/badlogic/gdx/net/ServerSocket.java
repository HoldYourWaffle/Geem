 ...
 * {@link Socket} instances. The {@link #accept(SocketHints)} method should
 * preferably be called in a separate thread as it is blocking.
 * 
 * @author mzechner
 * @author noblemaster
 */
public interface ServerSocket extends Disposable {
	 ...
	 * thread.
	 * 
	 * @param hints additional {@link SocketHints} applied to the accepted
	 *              {@link Socket}. Input null to use the default setting provided
	 *              by the system.
