...
/**
 * Track properties of a stream of float values. The properties (total value,
 * minimum, etc) are updated as values are {@link #put(float)} into the stream.
 * 
 * @author xoppa
 */
public class FloatCounter {
	 ...
	 * 
	 * @param windowSize The size of the mean window or 1 or below to not use a
	 *                   windowed mean.
	 */
