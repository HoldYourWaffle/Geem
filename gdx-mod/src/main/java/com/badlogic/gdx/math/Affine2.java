 ...
 * transformations</a> preserve straight lines, and parallel lines remain
 * parallel after the transformation. Operations on affine matrices are faster
 * because the last row can always be assumed (0, 0, 1).
 *
 * @author vmilea
 */
public final class Affine2 implements Serializable {
	 ...
	 * </pre>
	 * 
	 * @param matrix The source matrix, assumed to be an affine transformation
	 *               within XY plane. This matrix will not be modified.
	 * @return This matrix for the purpose of chaining operations.
	 */
