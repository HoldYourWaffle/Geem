...
public class RandomXS128 extends Random {
	 ...
	 * value.
	 * <p>
	 * The given seed is passed twice through a hash function. This way, if the user
	 * passes a small value we avoid the short irregular transient associated with
	 * states having a very small number of bits set.
	 * 
	 * @param seed a nonzero seed for this generator (if zero, the generator will be
