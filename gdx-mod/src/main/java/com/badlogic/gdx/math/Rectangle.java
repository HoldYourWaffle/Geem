...
public class Rectangle implements Serializable, Shape2D {
	 ...
	 * This scales and centers the rectangle to the other rectangle (e.g. Having a
	 * camera translate and scale to show a given area)
	 * 
	 ...
	 * This scales and centers the rectangle to the other rectangle (e.g. Scaling a
	 * texture within a arbitrary cell without squeezing)
	 * 
