...
public interface Path<T> {
	 ...
	 *         might be optimized for speed against precision, see
	 *         {@link #locate(Object)} for a more precise (but more intensive)
	 *         method.
	 */
	 ...
	 *         to the specified value. Note that the implementation of this method
	 *         might be CPU intensive, see {@link #approximate(Object)} for a faster
	 ...
	 *                intensive.
	 * @return An approximated length of the spline through sampling the curve and
