...
public final class GeometryUtils {
	 ...
	 * triangle.
	 * <p>
	 * If barycentric.x >= 0 && barycentric.y >= 0 && barycentric.x + barycentric.y
	 * <= 1 then the point is inside the triangle.
	 * <p>
	 * If vertices a,b,c have values aa,bb,cc then to get an interpolated value at
	 * point p:
	 * 
	 * <pre>
	...
	/**
	 * Returns interpolated values given the barycentric coordinates of a point in a
	 * triangle and the values at each vertex.
	 * 
	...
	/**
	 * Returns an interpolated value given the barycentric coordinates of a point in
	...
	/**
	 * Returns the lowest positive root of the quadric equation given by a* x * x +
	 * b * x + c = 0. If no solution is given Float.Nan is returned.
	 * 
	 ...
	 * <p>
	 * Gary L. Miller, Dafna Talmor, Shang-Hua Teng, and Noel Walkington. A Delaunay
	 * Based Numerical Method for Three Dimensions: Generation, Formulation, and
	 * Partition.
	 */
