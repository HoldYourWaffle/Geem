...
public interface Files {
	 ...
	 * classpath is checked. This enables files to be found when using JWS or
	 * applets. Internal files are always readonly.
	 */
	Internal,

	/**
	 * Path relative to the root of the SD card on Android and to the home directory
	 * of the current user on the desktop.
	 */
	External,

	/**
	 * Path that is a fully qualified, absolute filesystem path. To ensure
	 * portability across platforms use absolute files only when absolutely (heh)
	 * necessary.
	 */
	Absolute,
	 ...
	 * @throws GdxRuntimeException if the type is classpath or internal and the file
	 *                             does not exist.
	 * @see FileType
	 */
	 ...
	 * and the home directory of the current user on the desktop.
	 */
